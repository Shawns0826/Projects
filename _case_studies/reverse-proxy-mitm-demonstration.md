...
![High-level view of the reverse-proxy broker model]({{ "/assets/images/mitm-reverse-proxy-overview.webp" | relative_url }})
...
![Request flow: attacker-facing auth vs upstreamed content]({{ "/assets/images/mitm-reverse-proxy-flow.webp" | relative_url }})
